...
const Navbar = () => {
  return (
    <div className="bg-black  h-auto sm:h-auto md:h-auto lg:h-auto text-white flex justify-evenly">
      <div className=" pl-1 flex items-center  gap-2 sm:pl  lg:px-2 lg:pl-[3rem]">
        <h2 className="text-red-700 font-bold text-[16px] mt-1 sm:text-[1.5rem] md:text-[2rem] lg:pl-8 ">
          RedPill
        </h2>
      ...
      <div className="lg:flex sm:flex md:flex pl-[8px] text-[8px] gap-2 sm:text-[14px] md:text-[14px] md:pl-6 flex-wrap lg:pl-[5rem] lg:gap-5 items-center hidden ">
      ...
      <div className="flex items-center justify-center pl-4 lg:pl-[3rem] outline-none border-none">
        <CiSearch className="text-white text-sm lg:text-[1.5rem] " />

        <input
          type="text"
          placeholder="search"
          className=" bg-transparent bg-slate-600  text-center border-none  outline-none"
        />
      </div>
    </div>
  );
